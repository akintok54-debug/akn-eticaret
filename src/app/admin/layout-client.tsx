...
const menu = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Abonelikler", href: "/admin/abonelikler" },
...
const available = new Set(["/admin/ayarlar/seo","/admin/mail-sms","/admin/guvenlik","/admin/urunler","/admin/kategoriler","/admin/markalar","/admin/varyantlar","/admin/ek-bilgiler","/admin/ek-ozellikler","/admin/urunler/aktarim","/admin/urunler/toplu","/admin/siparisler","/admin/abonelikler","/admin/taslak-siparisler","/admin/iptal-iade","/admin/aktif-sepetler","/admin/terk-edilen-sepetler","/admin/terk-edilen-siparisler","/admin/sepet-hatirlatma","/admin/risk-kriterleri","/admin/musteriler","/admin/bayiler","/admin/uye-gruplari","/admin/destek-talepleri","/admin/hediye-cekleri","/admin/entegrasyonlar","/admin/entegrasyonlar/feed","/admin/entegrasyonlar/google-merchant","/admin/entegrasyonlar/meta","/admin/entegrasyonlar/google-analytics","/admin/entegrasyonlar/google-tag-manager","/admin/entegrasyonlar/tiktok-pixel","/admin/entegrasyonlar/api","/admin/istatistikler","/admin/istatistikler/siparis","/admin/istatistikler/urun","/admin/raporlar","/admin/ayarlar","/admin/ayarlar/firma","/admin/dosya-yonetimi","/admin/yasal-sozlesmeler","/admin/kullanicilar","/admin/tasarim-ayarlari","/admin/kargo-ayarlari","/admin/odeme-ayarlari"]);
