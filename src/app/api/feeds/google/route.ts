...
export async function GET(request:Request){
 ...
 const xml=`<?xml version="1.0" encoding="UTF-8"?><rss xmlns:g="http://base.google.com/ns/1.0" version="2.0"><channel><title>AKN Motosiklet</title><link>${esc(root)}</link><description>AKN Motosiklet ürün kataloğu</description>${items}</channel></rss>`;
