...
export const integrationItems: IntegrationItem[] = [
  { slug:"sipay", name:"Sipay", description:"Sipay sanal POS ödeme altyapısını yönetin.", type:"Ödeme Sistemi", mode:"settings", fields:[{key:"merchantId",label:"Mağaza Numarası"},{key:"merchantKey",label:"Mağaza Anahtarı",secret:true},{key:"apiKey",label:"API Key",secret:true},{key:"merchantSecret",label:"Merchant Secret",secret:true},{key:"environment",label:"POS Ortamı",placeholder:"Canlı veya Test"},{key:"securityType",label:"Güvenlik Tipi",placeholder:"Standart 3D"}] },
  { slug:"bahadir-erp-v2", name:"Bahadır ERP V2", description:"Ürün, stok, fiyat, müşteri ve sipariş verilerini AKN E-Ticaret ile çift yönlü senkronize edin.", type:"ERP", mode:"settings", fields:[{key:"baseUrl",label:"ERP API adresi",placeholder:"https://www.benimmuhasebe.com"},{key:"clientId",label:"ERP Client ID"},{key:"clientSecret",label:"ERP Client Secret",secret:true}] },
