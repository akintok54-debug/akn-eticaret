...
export type Order={legalAcceptances?:Array<{id:string;documentType:string;version:string;title:string;content:string;acceptedAt:string}>;subtotal?:number;shippingTotal?:number;couponCode?:string;shippingCompany?:string;trackingNumber?:string;trackingUrl?:string;paymentStatus?:string;paidAt?:string;returnRequestedAt?:string;returnReason?:string;discountTotal?:number;id:string;orderNumber:string;createdAt:string;customer:{fullName:string;phone:string;email:string};delivery:{city:string;district:string;address:string};invoice:{type:"individual"|"corporate";companyName:string;taxOffice:string;taxNumber:string};shippingMethod:string;paymentMethod:string;items:OrderItem[];total:number;status:OrderStatus};
